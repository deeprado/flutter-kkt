                          ...
                          children: <Widget>[
                            new Container(
                              child: new Text(
                                "57",
                                style: new TextStyle(
                                    fontSize: 16.0, color: Config.fontColor),
                              ),
                            ),
                            new Container(
                              child: new Text(
                                "我的创作",
                                style: new TextStyle(
                                    fontSize: 12.0, color: Config.fontColor),
                              ),
                            ),
                          ],
                        ),
                ...
                onPressed: () {
                  setState(() {
                    if (Config.dark == true) {
                      ...
                      Config.searchBackgroundColor = new Color(0xFFEBEBEB);
                      Config.cardBackgroundColor = Colors.white;
                      Config.fontColor = Colors.black54;
                      Config.dark = false;
                    } else {
                      Config.themeData = new ThemeData.dark();
                      Config.searchBackgroundColor = Colors.white10;
                      Config.cardBackgroundColor = new Color(0xFF222222);
                      Config.fontColor = Colors.white30;
                      Config.dark = true;
                    }
                  });
                },
                child: new Container(
                  child: new Column(
                    children: <Widget>[
                      ...
                      new Container(
                        child: new Text(Config.dark == true ? "日间模式" : "夜间模式",
                            style: new TextStyle(
                                color: Config.fontColor, fontSize: 14.0)),
                      )
                    ],
