...
class AliPayPage extends StatefulWidget {
  AliPayPage({Key key}) : super(key: key);
...
class _AliPayPageState extends State<AliPayPage> {
  ...
  Widget build(BuildContext context) {
    return new AlertProvider(child: new Main());
  }
}
...
class _MainState extends State<Main> {
  ...
  void setSchema() async {
    await FlutterAlipay.setIosUrlSchema("flutteralipaydemo");
  }
  ...
  void _loadData() {
    ...
    http
        .post("http://192.168.1.104:8095/api/pay/prePay", body: json.encode({}))
