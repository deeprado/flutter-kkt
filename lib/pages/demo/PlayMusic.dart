...
class _PlayMusicPageState extends State<PlayMusicPage> {
  ...
  Future _loadFile() async {
    ...
    final file = File('${dir.path}/assets/audios/audio.mp3');
  ...
  Widget localAsset() {
    return SingleChildScrollView(
      child: _Tab(children: [
        ...
        _Btn(txt: 'Play', onPressed: () => audioCache.play('audios/audio.mp3')),
        Text('Loop Local Asset \'audio.mp3\':'),
        _Btn(txt: 'Loop', onPressed: () => audioCache.loop('audios/audio.mp3')),
        Text('Play Local Asset \'audio2.mp3\':'),
        _Btn(txt: 'Play', onPressed: () => audioCache.play('audios/audio2.mp3')),
        Text('Play Local Asset In Low Latency \'audio.mp3\':'),
        _Btn(
            txt: 'Play',
            onPressed: () =>
                audioCache.play('audios/audio.mp3', mode: PlayerMode.LOW_LATENCY)),
        Text('Play Local Asset Concurrently In Low Latency \'audio.mp3\':'),
        _Btn(
            txt: 'Play',
            onPressed: () async {
              await audioCache.play('audios/audio.mp3', mode: PlayerMode.LOW_LATENCY);
              await audioCache.play('audios/audio2.mp3', mode: PlayerMode.LOW_LATENCY);
            }),
        Text('Play Local Asset In Low Latency \'audio2.mp3\':'),
        _Btn(
            txt: 'Play',
            onPressed: () =>
                audioCache.play('audios/audio2.mp3', mode: PlayerMode.LOW_LATENCY)),
  ...
  Future<int> _getDuration() async {
    File audiofile = await audioCache.load('audios/audio2.mp3');
  ...
  Widget notification() {
    return _Tab(children: [
      ...
      _Btn(
          txt: 'Play',
          onPressed: () =>
              audioCache.play('audios/messenger.mp3', isNotification: true)),
    ]);
  }
