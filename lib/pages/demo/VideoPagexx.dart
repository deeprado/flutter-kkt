...
class _VideoPageState extends State<VideoPage> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 3,
      child: Scaffold(
        key: const ValueKey<String>('video_list'),
        appBar: AppBar(
          ...
          bottom: const TabBar(
            ...
            tabs: <Widget>[
              ...
              Tab(icon: Icon(Icons.insert_drive_file), text: "本地"),
              Tab(icon: Icon(Icons.list), text: "视频列表"),
            ],
          ),
        ),
        body: TabBarView(
          ...
          Column(
            children: <Widget>[
              ...
              Stack(
                  ...
                  children: <Widget>[
                    _ButterFlyAssetVideo(),
                    Image.asset('assets/videos/flutter-mark-square-64.png'),
                  ]),
            ],
          ),
        ])),
