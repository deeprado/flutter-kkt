...
class GZXIcons {
  ...
  static const String DEFAULT_REMOTE_PIC =
      'https://raw.githubusercontent.com/CarGuo/GSYGithubAppFlutter/master/assets/images/logo.png';

  static const String tmall_easy_buy = 'assets/images/tmall_easy_buy.png';
  static const String huangjiaju = 'assets/images/cute_cat.jpeg';

  static const IconData home =
      const IconData(0xe6b8, fontFamily: GZXIcons.FONT_FAMILY);
  static const IconData home_active =
      const IconData(0xe652, fontFamily: GZXIcons.FONT_FAMILY);

  static const IconData we_tao =
      const IconData(0xe6f5, fontFamily: GZXIcons.FONT_FAMILY);
  static const IconData we_tao_fill =
      const IconData(0xe6f4, fontFamily: GZXIcons.FONT_FAMILY);

  static const IconData message =
      const IconData(0xe6bc, fontFamily: GZXIcons.FONT_FAMILY);
  static const IconData message_fill =
      const IconData(0xe779, fontFamily: GZXIcons.FONT_FAMILY);

  static const IconData cart =
      const IconData(0xe6af, fontFamily: GZXIcons.FONT_FAMILY);
  static const IconData cart_fill =
      const IconData(0xe6b9, fontFamily: GZXIcons.FONT_FAMILY);

  static const IconData my =
      const IconData(0xe78b, fontFamily: GZXIcons.FONT_FAMILY);
  static const IconData my_fill =
      const IconData(0xe78c, fontFamily: GZXIcons.FONT_FAMILY);
